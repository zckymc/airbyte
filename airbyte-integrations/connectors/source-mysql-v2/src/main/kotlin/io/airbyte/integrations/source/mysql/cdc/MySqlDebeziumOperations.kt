...
class MySqlDebeziumOperations(
    ...
    override fun toAirbyteRecordMessage(record: DebeziumRecord): AirbyteRecordMessage {
    ...
    override fun position(record: DebeziumRecord): MySqlPosition? {
        val file: JsonNode = record.source["file"]?.takeIf { it.isTextual } ?: return null
        val pos: JsonNode = record.source["pos"]?.takeIf { it.isIntegralNumber } ?: return null
